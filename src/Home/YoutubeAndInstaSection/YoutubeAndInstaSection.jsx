...
const YoutubeAndInstaSection = () => {
  return (
    <div className="bg-[#d7f1f4] px-[9%] py-[45px] lg:py-[65px] flex lg:flex-row flex-col gap-[45px] mx-auto justify-center items-center">
      <div className="space-y-2 lg:w-[50%] w-full overflow-hidden">
        ...
        <div className="w-full">
          <iframe
            className="md:w-full w-[450px] lg:h-[350px] h-[310px]"
