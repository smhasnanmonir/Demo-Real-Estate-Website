...
const IntroDuction = () => {
  ...
  return (
    <div className="mb-5 lg:px-[350px] md:px-[150px] px-[25px] mx-auto bg-[#28282B] text-white">
      <div className="flex items-center justify-between py-4 md:flex-row flex-col">
        <div className="flex items-center gap-2">
          <FaHouse size={50}></FaHouse>
          <p className="md:text-3xl text-xl font-bold">Find a property</p>
        </div>
        <div className="flex gap-3 md:mt-0 mt-[20px]">
          ...
          <>
            <Link
              ...
              className="btn md:text-[16px] text-black hover:bg-slate-100 hover:text-black md:w-[150px] w-[120px]"
            >
