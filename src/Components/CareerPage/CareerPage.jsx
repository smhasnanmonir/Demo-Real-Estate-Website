...
import career from "../../../src/assets/Career/career.jpg";
...
const CareerPage = () => {
  ...
  return (
    <div>
      <SharedFrontPage
        backgroundImg={career}
        heading1="Career"
        heading2="Welcome on board"
      ></SharedFrontPage>
      <div className="bg-[#78909C] px-[25px] md:py-5 md:pl-[150px] py-[25px] text-white">
        <h1 className="text-[45px] py-[25px] uppercase">Share your details </h1>
